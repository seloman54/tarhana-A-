...
const App: React.FC = () => {
  ...
  const handleCreateRecipe = async () => {
    ...
    setLoading(true);
    setError(null);
    // Note: We don't clear the previous recipe immediately to prevent flickering if we were to show a loading state over it,
    // but here we show a loading spinner on the button.
